...
-- data.sql will not be executed if you are connecting to a real database. The things present in data.sql are only executed if you are connecting to an in-memory database.